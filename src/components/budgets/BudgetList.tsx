    ...
    <>
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold text-gray-700">My Budgets</h2>
          <button
        ...
        {budgets.length === 0 ? (
          ...
          <div className="space-y-4">
            {budgets.map((budget) => {
              ...
              return (
                <div key={budget.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition">
